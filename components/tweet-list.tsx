  ...
  return (
    <div>
      ...
      <div className="w-full max-w-screen-sm flex bottom-32 fixed mx-auto gap-10 items-center justify-center">
        <button
          className="text-gray-900 dark:text-white disabled:text-gray-300 dark:disabled:text-gray-600 hover:text-blue-500 dark:hover:text-blue-400 transition-colors"
